...
variable_name = generate_variable_name('t7.1', 'fiber')
...
total_amount = mats_price * daily_crafts
...
refined_resource_cost = int(max_price_refined(show_max_price_df))
...
total_daily_profit = returned_resources + (refined_resource_cost * daily_crafts)
